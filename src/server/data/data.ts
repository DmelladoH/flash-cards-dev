export const data: any = [
  ...
  },
  {
    ...
    answer: `
        ...
        <br/><br/>
        Boxing is a form of implicit coercion it happens when you are trying to use something that is not an object as an object, 
        like accessing the length property of a string. JS coerce that primitive into an object.
    `,
    category: "JavaScript",
